     ...
     <div className="row justify-content-center">
       <div className="col-lg-4 col-md-6 col-sm-12">
         <div className="accessories-card">
           <div className="accessories-content text-center">
             <h2 className="accessories-size">Chairs</h2>
             <img className="accessories-image" src="./images/default.png" alt="" />
             <p className="accessories-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
       ...
       <div className="col-lg-4 col-md-6 col-sm-12">
         <div className="accessories-card">
           <div className="accessories-content text-center">
             <h2 className="accessories-size">Tables</h2>
             <img className="accessories-image" src="./images/default.png" alt="" />
             <p className="accessories-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
              sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
               quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
       ...
       <div className="col-lg-4 col-md-6 col-sm-12">
         <div className="accessories-card">
           <div className="accessories-content text-center">
             <h2 className="accessories-size">Plastic Tables</h2>
             <img className="accessories-image" src="./images/default.png" alt="" />
             <p className="accessories-description">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
              sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
               quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. 
